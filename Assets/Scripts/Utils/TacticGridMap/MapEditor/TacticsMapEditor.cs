...
public class TacticsMapEditor : EditorWindow
{
    ...
    {
        bannerImage = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/EditorAssets/banner_MapEditor.jpg");
        if (bannerImage == null)
